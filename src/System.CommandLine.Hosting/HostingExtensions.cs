...
namespace System.CommandLine.Hosting
{
    ...
    {
        public static ParseResult UseHost(
            this ParseResult context,
            Func<string[], IHostBuilder> hostBuilderFactory,
            Action<IHostBuilder> configureHost = null)
        {
            var rootCommand = context.RootCommandResult.Command;
            if (rootCommand is RootCommand root)
            {
                root.Add(new Directive(HostingAction.HostingDirectiveName));
            }

            HostingAction.SetHandlers(rootCommand, hostBuilderFactory, configureHost);
        ...
        public static ParseResult UseHost(
            this ParseResult context,
            Action<IHostBuilder> configureHost = null
        ) => UseHost(context, null, configureHost);
